...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\User\Desktop\pastas git\Flask_Python\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\User\Desktop\pastas git\Flask_Python\venv\Scripts\deactivate.nu'
